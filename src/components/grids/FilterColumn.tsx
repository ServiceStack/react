...
export default function FilterColumn({
    ...
    const txtFilter = useRef<any>(null)
    ...
    const filters = useMemo(() => settings.filters, [settings.filters])

    // Effect equivalent to watchEffect for settings
    useEffect(() => {
    ...
    // Effect equivalent to watchEffect for selectedEnums
    useEffect(() => {
    ...
    // Effect equivalent to @vue:mounted
    useEffect(() => {
        setNewQuery('%')
